...
#include "../../Archive/Zip/ZipHeaderRebelVersion.h"
#endif
...
#ifdef ZIP_HEADER_REBEL
static const char *kZipHeaderRebelString =
    "Zip header rebel " ZIP_HEADER_REBEL_VERSION_COPYRIGHT "\n";
#endif
...
static const char *kHelpString =
    ...
    "  uh : Update Header only to archive\n"
    ...
    "  -h{Parameters} : set Header information\n"
    ...
    "  -uh{d|f} : Update directory or file Header only to archive\n"
  ...
  else if (isExtractGroupCommand || options.Command.CommandType == NCommandType::kList)
  {
    ...
    if (isExtractGroupCommand)
    {
      ...
      */
      ...
      eo.HeaderProperties = options.HeaderProperties;
      #endif
